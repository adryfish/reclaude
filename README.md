...
- [Linux 下载](https://github.com/adryfish/reclaude/releases/download/1.11.0/reclaude_linux)
...
| RECLAUDE_DISABLE_ADMIN_FEATURE | 设置则不能打开setting中的账单等敏感页面，对应的接口也会屏蔽 | true |
